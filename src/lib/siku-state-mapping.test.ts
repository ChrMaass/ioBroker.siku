    ...
    it('decodes mapped sensor, timer and diagnostic states from one packet', () => {
        const packet = buildPacket(
            ...
            Buffer.from([
                ...
                0x20, 0x03, 0xfe, 0x04, 0x64, 0x05, 0x02, 0x01, 0x00, 0xfe, 0x06, 0x86, 0x01, 0x02, 0x03, 0x04, 0xea,
                0x07, 0x83, 0x01, 0x88, 0x01, 0xff, 0x03, 0xfe, 0x02, 0x02, 0x0f, 0x00, 0xfe, 0x02, 0x03, 0x1e, 0x00,
                0x04, 0x01, 0x05, 0x00,
            ]),
        );
